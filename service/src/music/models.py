...
from src.accounts.services.services import (
    get_album_path,
    get_track_path,
...
class Track(models.Model):
    ...
    album = models.ForeignKey(
        Album, on_delete=models.SET_NULL, related_name="tracks", blank=True, null=True
    )
    ...
    users_of_likes = models.ManyToManyField(User, related_name="likes", blank=True)
    private = models.BooleanField(default=False)
    image = models.ImageField(
...
class Playlist(models.Model):
    name = models.CharField(
        max_length=100, default="New Playlist", unique=True, null=True, blank=True
    )
